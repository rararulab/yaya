...
/**
 * Client-side mirror of ``yaya.kernel.providers.is_valid_instance_id``.
 *
 * 3-64 lowercase alphanumeric / dash characters, no leading/trailing
 * dashes, no dots. Surfacing the inline error before POST saves a
 * round-trip and keeps the message under the UI's control.
 */
